$('document').ready(function() {
  ...
  Calculate.mealTotalCalories($('.breakfast-list'));
  Calculate.mealTotalCalories($('.lunch-list'));
  Calculate.mealTotalCalories($('.dinner-list'));
  Calculate.mealTotalCalories($('.snacks-list'));

  calculateGrandTotalCalories();

  Calculate.mealRemainingCalories($('.breakfast-list'));
  Calculate.mealRemainingCalories($('.lunch-list'));
  Calculate.mealRemainingCalories($('.dinner-list'));
  Calculate.mealRemainingCalories($('.snacks-list'));
