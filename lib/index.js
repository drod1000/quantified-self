$('document').ready(function() {
  ...
  Calculate.totalMealCalories($('.breakfast-list'));
  Calculate.totalMealCalories($('.lunch-list'));
  Calculate.totalMealCalories($('.dinner-list'));
  Calculate.totalMealCalories($('.snacks-list'));
